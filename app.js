...
app.post("/delete", async function (req, res) {
  ...
  var myquery = { _id: id, username: username, videoname: videoname, audioname: audioname };
  console.log("hello4")
  ...
  // await collection.deleteOne({ _id: id, username: username, videoname: videoname, audioname: audioname }, function (err, obj) {
  //   if (err) {
  //     console.log(err);
  //   } else {
